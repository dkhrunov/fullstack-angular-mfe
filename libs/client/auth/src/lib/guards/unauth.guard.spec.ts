...
// 			providers: [UnauthorizedGuard, { provide: Router, useValue: routerMock }],
...
// 		jest.spyOn(userService, 'isUserLoggedIn$', 'get').mockReturnValue(of(true));
//
...
// 		jest.spyOn(userService, 'isUserLoggedIn$', 'get').mockReturnValue(of(false));
//
// 		guard.canLoad().subscribe((x) => {
// 			expect(x).toBeTruthy();
// 			done();
